                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="unitDropdownSelect" class="form-control select2 select2-hidden-accessible" name="department">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control auto ui-autocomplete-input" placeholder="Enter Order Placed by" value="<?php echo $username; ?>" name="order_placed_by" id="order_placed_by">
...
// For adding Supplier
                            ...
                            function add_pr() {
                                ...
                                $.ajax({
                                    ...
                                    data: {department_id: department_id,unit_id: unit_id, issuing_date: issuing_date, phone_person: phone_person, supplier_name: supplier_name, action_taken_by: action_taken_by, pr_reacd_on: pr_reacd_on, order_placed_by: order_placed_by, selectedOption: selectedOption},
                                    success: function (data) {
                                        alert(data);
                                        // data = JSON.parse(data);
                                        //json_decode($data);
